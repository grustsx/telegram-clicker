...
import { VodkaWell } from '@/widgets/vodka-well';
import MysteryUpgrade from './MysteryUpgrade';
import { TortikSpells } from '@/widgets/tortik-spell';
...
const BuildingInfo = ({
  ...
  const handleClick = (buildingId: number) => {
    ...
    dispatch(buyBuildingLevelThunk(buildingId));
